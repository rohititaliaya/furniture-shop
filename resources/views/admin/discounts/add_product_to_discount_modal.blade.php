<div class="modal fade" id="add-product-to-discount-modal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div method="dialog" class="w-full h-full">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Discount for products</h5>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="table-responsive" style="min-height: 344px">
                                        <table class="js-user-table table table-vcenter card-table">
                                            ...
                                            <tbody id="detailed-products-table">
                                                @foreach ($products_not_in_discount as $detailed_product)
                                                    @php
                                                        $today = now();
                                    ...
                                    <div class="js-detailed-products-pagination d-flex justify-content-end my-2">
                                        {{ $products_not_in_discount->render('common.ajax-pagination') }}
                                    </div>
                                </div>
                            </div>
                        </div>
