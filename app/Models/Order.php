...
class Order extends Model
{
    ...
    protected $fillable = ['total_price', 'is_paid', 'status', 'receiver_name', 'address', 'state', 'city', 'pincode', 'phone_number', 'customer_id', 'created_by', 'note'];    //mảng các trường có thể tác động
